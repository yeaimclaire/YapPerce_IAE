...
- Port 4001-4005 dan 3307, 3309-3311 tersedia
...
```
user-service    | User Service running on http://localhost:4001/graphql
product-service | Product Service running on http://localhost:4002/graphql
order-service   | Order Service running on http://localhost:4003/graphql
payment-service | Payment Service running on http://localhost:4004/graphql
shipxpress      | ShipXpress Mock Service running on http://localhost:4005/graphql
```
...
- ShipXpress: http://localhost:4005/graphql
