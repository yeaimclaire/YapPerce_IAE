...
- **ShipXpress Mock GraphQL**: http://localhost:4005/graphql
...
Endpoint ShipXpress: `http://shipxpress:4005/graphql` (internal) atau `http://localhost:4005/graphql` (external)
